    ...
    <div class="col-md-4">
      <div class="panel b-a">
        ...
        <div class="item m-l-n-xxs m-r-n-xxs">
          ...
          <img src="./instyle/index/img/c0.jpg" class="img-full">
        </div>
          ...
          <div class="panel b-a">
            ...
            <div class="text-center m-b clearfix">
              <div class="thumb-lg avatar m-t-n-xxl">
                <img src="./instyle/index/img/a5.jpg" alt="..." class="b b-3x b-white">
          ...
          <div class="panel panel-info">
            <div class="panel-body">
              <a href class="thumb pull-right m-l m-t-xs avatar">
                <img src="./instyle/index/img/a4.jpg" alt="...">
          ...
          <div class="clearfix text-center m-t">
            <div class="inline">
              <div ui-jq="easyPieChart" ui-options="{
                ...
                <div class="thumb-xl">
                  <img src="./instyle/index/img/a8.jpg" class="img-circle" alt="...">
                </div>
              </div>
  ...
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="m-b">
            <a href class="pull-left thumb-sm avatar"><img src="./instyle/index/img/a2.jpg" alt="..."></a>
            <div class="m-l-xxl">
          ...
          <div class="m-b">
            <a href class="pull-right thumb-sm avatar"><img src="./instyle/index/img/a3.jpg" class="img-circle" alt="..."></a>
            <div class="m-r-xxl">
        ...
        <footer class="panel-footer">
          <!-- chat form -->
          <div>
            <a class="pull-left thumb-xs avatar"><img src="./instyle/index/img/a3.jpg" class="img-circle" alt="..."></a>
      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body" ui-jq="slimScroll" ui-options="{height:'250px', size:'8px'}">
          <div class="media">
            <span class="pull-left thumb-sm"><img src="./instyle/index/img/a2.jpg" alt="..."></span>
    ...
    <div class="col-lg-6">
      ...
      <div class="m-b b-l m-l-md streamline">
        <div>
          <a class="pull-left thumb-sm avatar m-l-n-md">
            <img src="./instyle/index/img/a1.jpg" class="img-circle" alt="...">
          </a>
        ...
        <div class="m-l-lg">
          <a class="pull-left thumb-sm avatar">
            <img src="./instyle/index/img/a8.jpg" alt="...">
          </a>          
        ...
        <div>
          <a class="pull-left thumb-sm avatar m-l-n-md">
            <img src="./instyle/index/img/a9.jpg" alt="...">
          </a>          
          <div class="m-l-lg panel b-a">
            <div class="panel-heading pos-rlt b-b b-light">
              <span class="arrow left"></span>                    
        ...
        <div>
          <a class="pull-left thumb-sm avatar m-l-n-md"><img src="./instyle/index/img/a5.jpg" alt="..."></a>          
          <div class="m-l-lg panel b-a">
            <div class="panel-heading pos-rlt b-b b-light">
              <span class="arrow left"></span>
              <a href>Peter</a>
      ...
      <div class="clearfix m-b-lg">
        <a class="pull-left thumb-sm avatar"><img src="./instyle/index/img/a6.jpg" alt="..."></a>
        <div class="m-l-xxl">
          <form class="m-b-none">
            <div class="input-group">
    ...
    <div class="col-sm-6">
      ...
      <div class="m-b m-t-lg">
        <a href class="avatar thumb-xs m-r-xs">
          <img src="./instyle/index/img/a7.jpg" alt="...">
        ...
        <a href class="avatar thumb-xs m-r-xs">
          <img src="./instyle/index/img/a10.jpg" alt="...">
          <i class="on b-white"></i>
        </a>
    ...
    <div class="col-sm-6">
      <div class="panel b-a">
        ...
        <ul class="list-group list-group-lg no-bg auto">
          ...
          <li class="list-group-item clearfix">
            <span class="pull-left thumb-sm avatar m-r">
              <img src="./instyle/index/img/a6.jpg" alt="...">
